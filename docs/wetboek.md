...
| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Westkust |
| Officiële naam            | Algemeen Wetboek Westkust |
| Citeertitel               | Wetboek Westkust |
...
1. Het Wetboek Westkust (verder aangeduid als WNMRP) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WNMRP heeft betrekking op het vaste land, de gemeente, en de stad Westkust.
3. Het WNMRP is nauw verweven met de Algemene Plaatselijke Verordening Westkust (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen Westkust op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in Westkust niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van Westkust waarbij het goed direct of indirect betrokken is, behalve fout parkeren en een snelheidsovertreding met uitzondering zoals beschreven in lid E van dit artikel;
...
---------------------
*Wetboek Westkust is opgesteld uit naam van de Hoge Raad, bedoeld voor de gemeente en de stad “Westkust”, opgetekend door silentsources.*