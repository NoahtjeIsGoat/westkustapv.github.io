...
| **Kenmerk**                | **Details**                          |
|----------------------------|--------------------------------------|
| Overheidsorganisatie       | Staff der Westkust                |
| Officiële naam regeling    | Algemene Plaatselijke Verordening Westkust |
| Citeertitel                | Algemene Plaatselijke Verordening Westkust |
...
Het Wetboek van Strafrecht, specifiek bedoeld voor Westkust, wordt hierbij overschreven door deze APV.
...
1. Deze Algemene Plaatselijke Verordening, hierna te noemen **APV**, is bedoeld als aanvulling op het Nederlands Recht en heeft betrekking op het eiland, de gemeente en de stad Westkust.
...
2. Het is niet toegestaan externe discords te gebruiken voor roleplay-gerelateerde zaken zonder toestemming van de staff.
    ...
    * Tijdens voicechats met andere spelers van Westkust geldt:
    ...
    * In calls zitten met je vrienden die geen Westkust spelen is ook verboden.
...
4. Officiële Westkust-kleding, bedoeld voor specifieke groeperingen, mag niet door anderen worden gebruikt of als startkleding worden gekozen, tenzij er een sterke en goedgekeurde roleplay aan verbonden is.
5. Kleding die aangekocht is via de Westkust website mag wel gedragen worden door iedereen. (Op eigen risico)
...
1. De voertalen op Westkust zijn **Nederlands** en **Engels**.
...
1. Het gebruik van beledigingen met betrekking tot relevante/hedendaagse ziektes, racistische of ongepaste opmerkingen is verboden op alle door Westkust erkende platformen.
...
4. Alle overeenkomsten met betrekking tot loodsen moeten schriftelijk worden vastgelegd en gedocumenteerd in de stad Westkust met het commando /docu, en dienen te worden ondertekend door alle betrokken partijen.
...
---
APV opgesteld uit naam van de Hoge Raad, bedoeld voor het eiland, de gemeente en de stad “Westkust”, opgetekend door silentsources.
